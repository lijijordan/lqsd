	...
	<div id="container">
		...
		<fieldset>
			...
			<form method="POST" enctype="multipart/form-data" action="${ctx}/site/add">
				<div class="editfrm">
					<ul>
						<li><label>名称：</label> <input id="title" name="name" type="text">
							<span id="err_userName"></span> <em>*</em></li>
						<li><label>短域名：</label> <input id="title" name="domain" type="text">
							<span id="err_userName"></span> <em>*英文单词，切换站点时显示的url</em></li>
						<li><label>电话：</label> <input id="title" name="phone" type="text">
							<span id="err_userName"></span> <em>*首页上显示的联系电话</em></li>
						<li><label>地址：</label> <input id="title" name="address" type="text">
							<span id="err_userName"></span> <em>*首页上显示的公司地址</em></li>
						<li><label>银行账户：</label> <input id="title" name="bank" type="text">
